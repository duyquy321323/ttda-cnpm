                    ...
                    <div className="bottom">
                            {environmentData.temperature < 10 && (
                                <span className="warning">
                                    CẢNH BÁO: Nhiệt độ quá thấp, có nguy cơ cảm lạnh. Hãy giữ ấm!
                                </span>
                            )}

                            {environmentData.temperature >= 10 && environmentData.temperature <= 25 && (
                                <span className="normal">
                                   THÔNG BÁO: Nhiệt độ lý tưởng, thời tiết dễ chịu.
                                </span>
                            )}

                            {environmentData.temperature > 25 && environmentData.temperature <= 35 && (
                                <span className="caution">
                                    THÔNG BÁO: Thời tiết ấm áp, nên uống đủ nước để tránh mất nước.
                                </span>
                            )}

                            {environmentData.temperature > 35 && environmentData.temperature <= 50 && (
                                <span className="danger">
                                    CẢNH BÁO: Nhiệt độ cao, có nguy cơ bị say nắng. Hãy giữ mát và bổ sung nước!
                                </span>
                            )}

                            {environmentData.temperature > 50 && (
                                <span className="extreme-danger">
                                    NGUY HIỂM: Nhiệt độ cực cao! Tương đương môi trường đang cháy. Hãy tìm nơi an toàn ngay!
                                </span>
                            )}
                        </div>
                        </div>
                    ...
                    <div className="right">
                        ...
                        <div className="bottom">
                            ...
                            {environmentData.light >= 90 && (
                                <span className="warning">
                                    NGUY HIỂM: Có thể gây khó chịu và ảnh hưởng đến thị lực, do đó nên điều chỉnh để giảm cường độ sáng nếu cần.
                                </span> 
                            )}
